...
(function (GitLogUtil) {
    ...
    GitLogUtil.readGitVersion = (dir) => __awaiter(this, void 0, void 0, function* () {
        const commit = yield exec(`cd ${dir} && git show -s --format=%H`);
        return commit.trim();
    });
    GitLogUtil.readGitLog = (dir, startVersion) => __awaiter(this, void 0, void 0, function* () {
        let command = `cd ${dir} && `;
        ...
        logArray.forEach((element) => {
            ...
            if (nameCheckText.includes('jenkins') || nameCheckText.includes('teamcity'))
                return;
